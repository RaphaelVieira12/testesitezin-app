...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$usuariosArray->nomeContato}}</td>
      <td>{{$usuariosArray->foneContato}}</td>
      <td>{{$usuariosArray->emailContato}}</td>
      <td>{{$usuariosArray->salaContato}}</td>
      
    <td>
      <a href="{{route('alterar-contato',$usuariosArray->id)}}">
